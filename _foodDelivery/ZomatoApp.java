...
public class ZomatoApp {
    ...
    public void initializeRestaurants() {
        Restaurant restaurant1 = new Restaurant("kake DI Hatti", "Kanpur");
        restaurant1.addMenuItem(new MenuItem("P1", "Malai Chaap", 120));
        restaurant1.addMenuItem(new MenuItem("P2", "Mutton Handi", 650));

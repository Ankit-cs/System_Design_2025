...
class ElectricCar2 extends Car1 {
    private int batteryLevel;

    public ElectricCar2(String brand, String model) {
        super(brand, model);
...
public class DPolymorphism {
    public static void main(String[] args) {
        Car1 myManualCar = new ManualCar2("Suzuki", "WagonR");
        ...
        Car1 myElectricCar = new ElectricCar2("Tesla", "Model S");

...
class ManualCar3 extends Car2 {
    private int currentGear;

    public ManualCar3(String brand, String model) {
        super(brand, model);
        this.currentGear = 0;
    }
...
class ElectricCar3 extends Car2 {
    private int batteryLevel;

    public ElectricCar3(String brand, String model) {
        super(brand, model);
...
// Main function
public class SDPolymorphism {
    public static void main(String[] args) {
        Car2 myManualCar = new ManualCar3("Ford", "Mustang");
        ...
        Car2 myElectricCar = new ElectricCar3("Tesla", "Model S");
